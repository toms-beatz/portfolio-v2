...
export default function Sidebar({activeTab}: { activeTab: string }) {
    ...
    return (
        <>
            <section
                className="flex flex-col lg:sticky top-14 lg:items-center max-h-full h-full mb-0 lg:pt-14 lg:pb-7 lg:px-7 p-7 bg-dark-2 rounded-2xl lg:max-w-[275px] w-full border-border border">
                <div className="flex lg:justify-center lg:flex-col lg:items-center gap-8">
                    <div className="flex flex-col items-center justify-center bg-dark-3 rounded-[30px] lg:w-32 lg:h-32 px-6 py-4 lg:py-2 lg:px-4">
                        {avatarSrc && <Image src={avatarSrc} alt="my-avatar" width={115} height={115}/>}
                    </div>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <Link href="tel:0615945951"><p className="text-sm">+33 6 15 94 59 51</p></Link>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-8">
