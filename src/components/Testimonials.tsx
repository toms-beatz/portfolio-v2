...
const Testimonials = () => {
    ...
    const truncateDesc = (desc: string) => {
        if (desc.length > 100) {
            return desc.substring(0, 150) + '...'; // Truncate and add ellipsis
        }
        return desc; // Return the original description if it's less than or equal to 100 characters
    };
                            ...
                            <DialogTrigger>
                                <span
                                    ...
                                    <span
                                        ...
                                        <Image src={testimonial.img} alt="profile" width={80} height={80} className="" />
                                    </span>
