"use client";
import {AppWindow, Database, Globe, Quote, TabletSmartphone} from "lucide-react"
...
export default function About() {
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid xl:grid-cols-2 gap-y-4 gap-x-6">
                <div
                ...
                <div
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-white text-sm">
                            Développement d’applications mobiles hybrides, avec une expérience fluide sur iOS et Android.
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid xl:grid-cols-2 grid-cols-1 xl:gap-y-4 gap-x-6 gap-y-16">
                    <Dialog>
                        <DialogTrigger>
                            <span
                                ...
                                <span className=" text-white !text-left text-sm">
                                    « Thomas est un jeune développeur web sérieux, je peux attester de ses compétences en
                                    node.js et php pour le backend et React.js pour le frontend, mais la vraie force
                                    d'un,
                                    profil comme Thomas, c'est... »
                                </span>
                            </span>
                        </DialogTrigger>
                        ...
                        <DialogContent className="bg-dark-2 border-border md:w-full w-10/12 rounded-2xl">
                            <DialogHeader>
                                ...
                                <DialogTitle className="text-center text-primary lg:-ml-20 md:ml-2 ml-20">Yan Bourquard-Ania</DialogTitle>
                                <DialogDescription className="!mt-6">
                                    <span className="text-white !text-left md:text-base text-sm">
                                        « Thomas est un jeune développeur web sérieux, je peux attester de ses compétences
                                        en
                                        node.js et php pour le backend et React.js pour le frontend, mais la vraie force
                                        d'un,
                                        profil comme Thomas, c'est sa vivacité d'esprit et sa capacité à s'adapter à un
                                        environnement de développement.
                                        Si vous cherchez un freelance pour concrétiser votre projet en développement ne
                                        cherchez
                                        plus vous avez trouver ! »
                                    </span>
                                </DialogDescription>
                            </DialogHeader>
                        </DialogContent>
