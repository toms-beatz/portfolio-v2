...
export default function Home() {
    ...
    return (
        <>
            <main className="flex w-full lg:px-28 lg:py-14 md:py-14 lg:pb-24 xl:pb-4 -mt-10 px-3 lg:gap-8 gap-[75px] lg:flex-row flex-col lg:justify-start justify-center lg:items-start items-center">
